    ...
    <main className="min-h-screen bg-background text-foreground transition-colors">
      ...
      <section id="about" className="py-16">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-10">
            Hydrojan is an advanced Autonomous Underwater Vehicle (AUV) built to
            tackle the challenges of underwater exploration. Designed and
            developed by the Dreams of Bangladesh team, Hydrojan is our
            submission for the prestigious RoboSub competition.
          </p>
          <Link
            href="/about"
            className="text-sea-green-600 hover:underline font-medium"
          >
            Learn More
          </Link>
        </div>
      ...
      <section id="3d-model" className="py-16 bg-gray-100 dark:bg-gray-900">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-10">
            Interact with our 3D model to get a closer look at Hydrojan's
            innovative design.
          </p>
      ...
      <section id="contact" className="py-16">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-10">
            Have questions or want to learn more about Hydrojan? Get in touch
            with us!
          </p>
          <Link
            href="/contact"
